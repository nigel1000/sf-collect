package com.common.collect.test.debug.netty;
    ...
    public static class HttpFileServerHandler extends SimpleChannelInboundHandler {
        ...
        protected void channelRead0(ChannelHandlerContext ctx, Object o) throws Exception {
            ...
            try {
                ...
                sendError(ctx, ExceptionUtil.getStackTraceAsString(ex));
                return;
            }
        ...
        public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
            if (ctx.channel().isActive()) {
                sendError(ctx, ExceptionUtil.getStackTraceAsString(cause));
            }
        }

...
import com.common.collect.lib.util.AlgorithmUtil;
...
public class AlgorithmUtilTest {
    ...
    public static void importantAesEn() {
        ...
        String key = "afsefsrgrwg11111";
        log.info(AlgorithmUtil.byteToHexStr(AlgorithmUtil.aesEncrypt(content.getBytes(StandardCharsets.UTF_8), key.getBytes(StandardCharsets.UTF_8))));
    }
    ...
    public static void importantAesDe() {
        ...
        log.info(new String(aesDecrypt, StandardCharsets.UTF_8));
    }
